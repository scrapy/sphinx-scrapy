...
INTERSPHINX_MAPPING = {
    ...
    "cssselect": ("https://cssselect.readthedocs.io/en/stable/", None),
    "curl-cffi": ("https://curl-cffi.readthedocs.io/en/latest/", None),
    "dateparser": ("https://dateparser.readthedocs.io/en/stable/", None),
    "form2request": ("https://form2request.readthedocs.io/en/stable/", None),
    "formasaurus": ("https://formasaurus.readthedocs.io/en/stable/", None),
    "itemloaders": ("https://itemloaders.readthedocs.io/en/stable/", None),
    ...
    "python-scrapinghub": (
        "https://python-scrapinghub.readthedocs.io/en/stable/",
        None,
    ),
    "python-zyte-api": ("https://python-zyte-api.readthedocs.io/en/stable/", None),
    "scrapy": ("https://docs.scrapy.org/en/latest/", None),
    "scrapy-lint": ("https://scrapy-lint.readthedocs.io/en/stable/", None),
    "scrapy-poet": ("https://scrapy-poet.readthedocs.io/en/stable/", None),
    "scrapy-spider-metadata": (
        "https://scrapy-spider-metadata.readthedocs.io/en/stable/",
        None,
    ),
    "scrapy-zyte-api": ("https://scrapy-zyte-api.readthedocs.io/en/stable/", None),
    "scrapy-zyte-smartproxy": (
        "https://scrapy-zyte-smartproxy.readthedocs.io/en/latest/",
        None,
    ),
    "scrapyd": ("https://scrapyd.readthedocs.io/en/stable/", None),
    "shub": ("https://shub.readthedocs.io/en/stable/", None),
    "shub-image": ("https://shub-image.readthedocs.io/en/stable/", None),
    "sphinx": ("https://www.sphinx-doc.org/en/master/", None),
    "spidermon": ("https://spidermon.readthedocs.io/en/stable/", None),
    ...
    "w3lib": ("https://w3lib.readthedocs.io/en/stable/", None),
    "web-poet": ("https://web-poet.readthedocs.io/en/stable/", None),
    "zyte": ("https://docs.zyte.com/", None),
    "zyte-common-items": ("https://zyte-common-items.readthedocs.io/en/stable/", None),
    "zyte-parsers": ("https://zyte-parsers.readthedocs.io/en/stable/", None),
    "zyte-spider-templates": (
        "https://zyte-spider-templates.readthedocs.io/en/stable/",
        None,
    ),
}
